...
No StorageGRID , a opção de política de grupo S3 “Mitigação de ransomware” facilita a implementação desta solução.  Ao criar um grupo de usuários no locatário, após selecionar as permissões do grupo, você pode ver esta política opcional.
