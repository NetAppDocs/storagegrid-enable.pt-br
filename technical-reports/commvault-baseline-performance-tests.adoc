...
[role="lead"]
Na operação de Cópia Auxiliar, quatro MediaAgents Commvault fizeram backup dos dados para um sistema NetApp AFF A300 e uma cópia auxiliar foi criada no NetApp StorageGRID.
