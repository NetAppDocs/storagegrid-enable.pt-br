...
Esta é uma visão geral dos muitos recursos de segurança do NetApp StorageGRID, abrangendo acesso a dados, objetos e metadados, acesso administrativo e segurança da plataforma. Ele foi atualizado para incluir os recursos mais recentes lançados com o StorageGRID 11,8.
...
Este documento é uma visão geral dos muitos recursos de segurança do StorageGRID 11,8, divididos em cinco categorias:
...
* Página de Documentação do StorageGRID 11,8 https://docs.netapp.com/us-en/storagegrid-118/[]
