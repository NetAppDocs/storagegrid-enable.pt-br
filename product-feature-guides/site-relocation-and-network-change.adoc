...
.Passos
. Caso uma nova sub-rede de rede Grid seja utilizada na nova localização, link:https://docs.netapp.com/us-en/storagegrid/expand/updating-subnets-for-grid-network.html["Adicione a sub-rede à lista de sub-rede da rede Grid"^]
...
. Acesse o appliance via SSH e desligue o nó usando "shutdown -h now"
