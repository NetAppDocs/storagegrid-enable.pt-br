...
. Verifique a  https://docs.cloudera.com/cdp-private-cloud-upgrade/latest/upgrade/topics/cdpdc-java-requirements.html["Matriz de suporte Cloudera"^]para a versão do JDK compatível.
